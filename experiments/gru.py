...
for activation in activation_functions:
    gru_model = GRUModel(input_shape=(sequence_length, 300), num_classes=1, activation_function=activation)
    gru_model.build(units=256, num_layers=1, dropout=0.2)
    ...
    evaluation_results = gru_model.evaluate(load_pickle.test_data, load_pickle.test_labels)
