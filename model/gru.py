...
class GRUModel:
    def __init__(self, input_shape, num_classes, activation_function):
        ...
        self.checkpoint_path = "best_gru_model.hdf5"  # Path to save the best model
    ...
    def build(self, units, num_layers=1, dropout=0.0):
        ...
        for i in range(num_layers):
            ...
            self.model.add(GRU(units, return_sequences=return_sequences, input_shape=(None, self.input_shape[-1]) if i == 0 else None))
            if dropout > 0:
